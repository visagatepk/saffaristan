...
import { HowToVerificationStructuredData, BreadcrumbStructuredData } from '@/components/StructuredData'
...
export default function AboutPage() {
  return (
    <>
      <HowToVerificationStructuredData />
      <BreadcrumbStructuredData items={[
        { name: 'Home', url: 'https://visagate.pk' },
        { name: 'About', url: 'https://visagate.pk/about' },
      ]} />
        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-8 py-14 space-y-14">
          ...
          <div>
            <div className="text-center mb-10">
              ...
              <h2 className="font-heading font-bold text-navy text-2xl lg:text-3xl mt-5 mb-2">Our Core Values</h2>
